...
import com.codeneitor.apprestapiinstagram.adapter.FavoritosAdapter;
...
public class MascotaFavoritos extends AppCompatActivity {
    ...
    public void iniciarListaMascotas(){
        ...
        mascotas.add(new Mascota(String.valueOf(R.drawable.garfield),"Huella",200));
        mascotas.add(new Mascota(String.valueOf(R.drawable.gyo),"Hueso",145));
        mascotas.add(new Mascota(String.valueOf(R.drawable.gyo2),"huella",124));
        mascotas.add(new Mascota(String.valueOf(R.drawable.oddie),"Favoritos",298));
        mascotas.add(new Mascota(String.valueOf(R.drawable.gato),"Huella",234));
